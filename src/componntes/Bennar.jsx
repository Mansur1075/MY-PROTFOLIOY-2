                            ...
                            <ul className="flex gap-6 justify-center items-center">
                                <Link to="https://github.com/Mansur1075" target="_blank">
                                    <li className="relative group"> <span className="absolute -top-10 left-1/2 -translate-x-1/2 scale-0 group-hover:scale-100 transition-all duration-300 bg-black text-white text-sm px-3 py-1 rounded-md"> GitHub  </span>
                                        <div className="w-14 h-14 flex items-center justify-center rounded-full bg-white text-gray-800 shadow-md cursor-pointer transition-all duration-300 group-hover:bg-gray-800 group-hover:text-white group-hover:-translate-y-2">
                                            <FaGithub size={22} />
                                         </div>
                                    </li>
                                </Link>
                                ...
                                <Link to="" target='_blank'>
                                    ...
                                    <li className="relative group">
                                        ...
                                        <div className="group w-14 h-14 flex items-center justify-center rounded-full bg-white text-[#D93025] shadow-md cursor-pointer transition-all duration-300 hover:bg-[#D93025] hover:text-white hover:-translate-y-2">
                                            <MdEmail size={24} />
                                        </div>
                                    </li>
                                </Link>
                                <Link to="https://www.facebook.com/share/1DCu6RZx89/" target='blank' >
                                    <li className="relative group">
                                        ...
                                        <div className="w-14 h-14 flex items-center justify-center rounded-full bg-white text-[blue] shadow-md cursor-pointer transition-all duration-300 group-hover:bg-[#0000ffb7] group-hover:text-white group-hover:-translate-y-2">
                                            <FaFacebook size={24} />
                                        </div>
                                    </li>
                                </Link>
